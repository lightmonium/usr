...
download:
	...
	@curl --silent --location https://github.com/ViRb3/wgcf/releases/download/v2.2.29/wgcf_2.2.29_linux_amd64 > local/bin/wgcf_linux_amd64
	@curl --silent --location https://github.com/zellij-org/zellij/releases/download/v0.43.1/zellij-x86_64-unknown-linux-musl.tar.gz | bsdtar --extract --directory='local/bin/' --file='-'
