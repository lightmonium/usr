...
download:
	...
	@curl --silent --location https://github.com/cloudflare/cloudflared/releases/download/2025.1.0/cloudflared-linux-amd64 > local/bin/cloudflared-linux-amd64
	...
	@curl --silent --location https://github.com/ViRb3/wgcf/releases/download/v2.2.24/wgcf_2.2.24_linux_amd64 > local/bin/wgcf_2.2.24_linux_amd64
