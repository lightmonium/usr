...
download:
	...
	@curl --silent --location https://github.com/vi/websocat/releases/download/v1.13.0/websocat.x86_64-unknown-linux-musl > local/bin/websocat.x86_64-unknown-linux-musl
